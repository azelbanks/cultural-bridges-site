    ...
    <>
      ...
      <section className="gradient-hero text-white py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">{t.blog_page.title}</h1>
          <p className="text-blue-200 text-lg max-w-2xl mx-auto">{t.blog_page.subtitle}</p>
        </div>
      </section>
      ...
      <section className="py-14 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          <article className="relative rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 p-8 md:p-12">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-4 leading-snug">{featured.title}</h2>
            <p className="text-text-light text-lg leading-relaxed mb-6">{featured.excerpt}</p>
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-6">
            {rest.map((article, i) => (
              <article
                key={article.id}
                className={`bg-white rounded-xl border border-border p-7 hover:shadow-lg transition-shadow flex flex-col ${
